/**
 * @file tests/generators/math/algebra/exponents-and-logarithms/exponent-rules/quotientOfPowersRule.test.js
 * @description Tests for the quotient of powers rule problem generator.
 */

const generateProblem = require("../../../../../../src/generators/math/algebra/exponents-and-logarithms/exponent-rules/quotientOfPowersRule");
...
describe("generateProblem", () => {
  ...
  it("generates a problem with correct steps", () => {
    ...
    expect(problem.steps[2].value).toBe(
      `Subtract the exponents: ${exponents[0]} - ${exponents[1]} = ${resultExponent}.`
    );
  });
