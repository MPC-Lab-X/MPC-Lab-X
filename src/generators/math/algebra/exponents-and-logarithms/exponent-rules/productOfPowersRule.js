/**
 * @file src/generators/math/algebra/exponents-and-logarithms/exponent-rules/productOfPowersRule.js
 * @description Generates problems involving the product of powers rule. Example: (a^3)(a^4) = a^7.
 */
...
const generateProblem = (options) => {
  ...
  const steps = [
    ...
    {
      type: "text",
      value: `Add the exponents: ${exponent1} + ${exponent2} = ${resultExponent}.`,
    },
  ];
